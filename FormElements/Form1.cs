...
namespace FormElements
{
    public partial class Form1 : Form
    {
        ...
        public Form1()
        {
            ...
            this.BackColor = Color.LightGray;//фон для формы
            tree = new TreeView();
            ...
            lbl1 = new Label();
            lbl1.Text = "На картинку можно нажать два раза";
        ...
        {
            MessageBox.Show("Ты выбрал HTML", "Результат");
        }

        private void Rdb2_Click(object sender, EventArgs e)
        {
            MessageBox.Show("Ты выбрал Python", "Результат");
        }
        ...
        private void Ptb_DoubleClick(object sender, EventArgs e)
        {
            ...
            else if (scetcikkartinok == 2)
            {
                ...
                ptb.ImageLocation = ("../../image/like.png");
            }
            else if (scetcikkartinok == 3)
            {
                ptb.ImageLocation = ("../../image/dog.gif");
            }
        ...
        private void Tree_AfterSelect(object sender, TreeViewEventArgs e)//(1) вот это
        {
            ...
            {
                MessageBox.Show("MessageBox", "Просто окно");
                ...
                if (answer == DialogResult.Yes)
                {
                    ...
                    if (MessageBox.Show("Хочешь добавить текст на экран?", "Текст сохранён", MessageBoxButtons.OKCancel) == DialogResult.OK)
                    {
                        //lbl.Text = text;
                        Controls.Add(lbl);
                    }
                    ...
                    {
                        MessageBox.Show("Тогда хорошо", "Ответ нет");
            ...
            else if (e.Node.Text == "MainMenu")
            {
                ...
                menuFile.MenuItems.Add("Väike", new EventHandler(menuFile_Vaike_Select));
        ...
        private void menuFile_Vaike_Select(object sender, EventArgs e)
        {
            this.Height = 600;//свойство высота формы
            this.Width = 800;
        }
